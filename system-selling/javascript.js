    ...
    mainContent.innerHTML = `
        <div style="padding: 2rem;">
            <div class="dashboard-header">
                <h1>Sales Operations Center</h1>
                <p>Monitor your sales pipeline and manage customer orders.</p>
            </div>
            <div class="admin-dashboard-links">
                <div class="admin-link-card" onclick="renderFunctionalDashboard('Sales Order Management')">
                    <i class="fas fa-shopping-cart fa-3x" style="color: #667eea; margin-bottom: 1rem;"></i>
                    <h3>Sales Order Management</h3>
                    <p>Manage customers, quotations, and orders.</p>
                </div>
                <div class="admin-link-card" onclick="window.location.href='reports.html'">
                    <i class="fas fa-chart-line fa-3x" style="color: #f97316; margin-bottom: 1rem;"></i>
                    <h3>Sales Reports</h3>
...
function initSidebarLayout() {
    ...
    header.innerHTML = `
        <div>
            <h2>Enterprise Navigation</h2>
            <p>Select a functional area to manage operations.</p>
        </div>
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    // If we are NOT on index.html, check for user
    if (page !== 'index.html' && page !== '') {
        ...
        if (page === 'overview.html' || page === 'dashboard.html') renderDashboardGrid();
